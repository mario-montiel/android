...
class AlumnosController extends Controller
{
    ...
    function viewMostrarAlumnos(){
        ...
        $alumnos = DB::table('personas')
                ->select('personas.matricula', 'personas.nombre', 'personas.usuario', 'personas.carreras_id_carrera', 'personas.cuatrimestre_id_cuatrimestre', 'solicitudes.horas_servicio_social')
