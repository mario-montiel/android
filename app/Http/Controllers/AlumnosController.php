...
class AlumnosController extends Controller
{
    ...
    function viewMostrarAlumnos(){
        ...
        $alumnos = DB::table('usuarios')
                ->select('usuarios.created_at', 'usuarios.updated_at', 'personas.matricula', 'personas.nombre', 'personas.carreras_id_carrera', 'personas.cuatrimestre_id_cuatrimestre', 'solicitudes.horas_servicio_social')
