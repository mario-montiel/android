...
class AlumnosController extends Controller
{
    ...
    function viewMostrarAlumnos(){
        ...
        $alumnos = DB::table('usuarios')
                ->select('personas.matricula', 'personas.nombre', 'personas.carreras_id_carrera', 'personas.cuatrimestre_id_cuatrimestre', 'solicitudes.horas_servicio_social', 'usuarios.created_at', 'usuarios.updated_at', )
