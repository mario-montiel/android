...
<div class="container">
  ...
  <div class="row">
   ...
   <div class="row">
   	<div class="col">
   		<button id="btn1" type="button" class="btn"> Ingrese su Usuario </button>
   	</div>
   </div>
   <div class="row">
   	<div class="col">
   		<button id="btn2" type="button" class="btn"> Ingrese su Contraseña </button>
   	</div>
   </div>
   <div class="row">
   	<div class="col">
   ...
   <div class="row">
   	<div class="col">
   		<a href="/inicioLogin" title=""> <button id="btn3" type="button" class="btn"></button> <h6 id="fb">Iniciar Sesión</h6></a>
   	</div>
   </div>
    <div class="row">
