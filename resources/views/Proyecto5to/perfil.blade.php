...
<head>
	...
	#imgoptions{
		height: 60px; margin-top: 80px; margin-left: 60px;
	}
	#container2{
	...
	#btn1{
		border-radius: 15px; background-color: #C74765; width: 160px; margin-left: 180px; margin-top: 15px;
	}
	</style>
</head>		
<body>
...
<div class="row">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col">
					...
					<a href="/chat"><img id="imgoptions" src="{{ asset('img/mensaje.png') }}"></a> 
	...
	<div id="container2" class="container col">
		<div class="container" style="margin-right: 50px; background-color: #E1DFE1; margin-top: 50px; border-radius: 15px;">
			...
			<div class="row">
				<div class="col">
					<button id="btn1" type="button" class="btn btn-danger">Agregar amistad</button>
				</div>
			</div>
