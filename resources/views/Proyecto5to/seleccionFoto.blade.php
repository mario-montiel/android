...
<head>
	...
	#imgedit{
		height: 65px; margin-top: 30px; margin-left: 60px;
	}
	#imgx{
		height: 65px; margin-top: 30px; margin-left: 130px;
	}
	</style>
</head>		
<body>
    ...
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button id="btn" class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <a href="/cambioFoto"><img id="imgback" src="{{ asset('img/back.png') }}"></a>  
        </button>
	...
	<div id="container1" class="container">
			<div class="row">
				<div class="col-4">
					...
					<a href="/cambioFoto"><img id="imgx" src="{{ asset('img/x.png') }}"></a> 
					<a href="/cambioFoto"><img id="imgedit" src="{{ asset('img/edit.png') }}"></a> 
				</div>
