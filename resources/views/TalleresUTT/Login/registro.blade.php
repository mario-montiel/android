...
<div id="contenedorlogin" class="container">
    <div id="card" class="card">
        <div class="card-body">
			...
			@if(Session::has('mal'))
				<center><span ><p class="alert alert-success">Algo salió mal, inténtelo de nuevo porfavor</p></span></center>
			@endif
...
@endif
            ...
            <form action="/registrarpersona" method="post">
                ...
                <div class="row">
					...
					<a style="color:white;" href="https://mega.nz/#!fiBF3AaI!79nLcJhZ4QXGEelQ5gy5BI7A2pC-WZZQa8ZQyb8kSVY"> Link para descargar aplicación movil </a>
					</div>
