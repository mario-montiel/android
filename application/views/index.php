...
<html lang="en">
  ...
  <body>
    ...
    <div id="app" v-cloak>    
      <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" v-cloak>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown" v-if="!login">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                  <a class="dropdown-item" href="#" v-if="perfil.jur.activo" @click="procesa_opcion(11)">Juridico 1</a>
                  <a class="dropdown-item" href="#" v-if="perfil.jur.activo">Juridico 2</a>
                  <a class="dropdown-item" href="#" v-if="perfil.pla.activo">Planeación 1</a>
                  <a class="dropdown-item" href="#" v-if="perfil.pla.activo">Planeación 2</a>
                  <a class="dropdown-item" href="#" v-if="perfil.scl.activo">Aprobación de solicitud</a>
                  <a class="dropdown-item" href="#" v-if="perfil.scl.activo">Solicitar monto</a>
                  <a class="dropdown-item" href="#" v-if="perfil.scl.activo">Revisión de solicitud</a>
                  <a class="dropdown-item" href="#" v-if="perfil.scl.activo">Reportes</a>
                </div>
              </li>
              <li class="nav-item">
